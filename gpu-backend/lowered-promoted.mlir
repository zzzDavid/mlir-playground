module {
  func @top(%arg0: memref<32x32xf32>, %arg1: memref<32x32xf32>) -> memref<32x32xf32> attributes {itypes = "__", otypes = "_"} {
    ...
    gpu.launch blocks(%arg2, %arg3, %arg4) in (%arg8 = %c32, %arg9 = %c1_3, %arg10 = %c1_3) threads(%arg5, %arg6, %arg7) in (%arg11 = %c32_1, %arg12 = %c1_3, %arg13 = %c1_3) {
      ...
      memref.store %cst, %1[%c0_4] {to = "sum_rv"} : memref<1xf32>
      affine.for %arg14 = 0 to 32 {
        %5 = memref.load %arg0[%2, %arg14] {from = "A"} : memref<32x32xf32>
        %6 = memref.load %arg1[%arg14, %3] {from = "B"} : memref<32x32xf32>
        %7 = arith.mulf %5, %6 : f32
        %8 = memref.load %1[%c0_4] {from = "sum_rv"} : memref<1xf32>
        %9 = arith.addf %7, %8 : f32
        memref.store %9, %1[%c0_4] {to = "sum_rv"} : memref<1xf32>
      } {loop_name = "k", reduction}
      %4 = memref.load %1[%c0_4] {from = "sum_rv"} : memref<1xf32>
      memref.store %4, %0[%2, %3] {to = "C"} : memref<32x32xf32>
      gpu.terminator
    }
